@echo off
REM Batch script to clean bin, obj, and Visual Studio files for SmartService
setlocal enabledelayedexpansion

REM Change to project root directory
cd /d "%~dp0\.."

powershell -Command "Write-Host '=== Cleaning SmartService ===' -ForegroundColor DarkCyan"
echo.
...
dotnet clean SmartService.sln --verbosity quiet

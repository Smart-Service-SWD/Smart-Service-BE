...
namespace SmartService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260306163404_AddAgentCapabilityServiceDefsAndServiceAgentUserId")]
    partial class AddAgentCapabilityServiceDefsAndServiceAgentUserId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartService.Domain.Entities.AgentCapability", b =>
                {
                    ...
                    b.Property<List<Guid>>("ServiceDefinitionIds")
                        .IsRequired()
                        .HasColumnType("jsonb");
